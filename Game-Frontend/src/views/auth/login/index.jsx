...
const Login = () => {
    ...
    useEffect(() => {
        if (forgotPasswordToken) {
            mutateVerifyToken(forgotPasswordToken);
        }
    }, [forgotPasswordToken]);
    ...
    const { register: forgotPwdRegister, handleSubmit: forgotPwdHandleSubmit, formState: { errors: forgotPwdErrors }, reset: forgotPWDReset } = useForm({
        mode: 'onSubmit'
    });
    ...
    const { mutate: mutateVerifyToken, isLoading: isLoadingVerifyToken } = useMutation(verifyToken, {
        onSuccess: (data) => {
    ...
    const onForgotPassword = (data) => {
        console.log('Forgot password:', data.forgotEmail);
        forgotPwdMutate({
    ...
    const onResetPassword = (data) => {
        console.log('Reset password:', data.newPassword, data.confirmPassword);
                ...
                <div className="auth-container">
                    <Row>
                        ...
                        <Col xl={6} lg={6} md={7} sm={12}>
                            {showForgotPassword && <div className="auth-box">
                            ...
                            {showResetFields && <div className="auth-box">
                                <div className="auth-form-container">
                            ...
                            {!showForgotPassword && !showResetFields && <div className="auth-box">
                                <div className="auth-form-container">
                                                ...
                                                <Form.Control
                                                    ...
                                                    {...register("email", {
                                                        ...
                                                        validate: (value) => {
                                                            ...
                                                            // Check if input is username (alphanumeric)
