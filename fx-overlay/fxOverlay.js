(function (global) {
  ...
  FXOverlay.smallBet = function (amount, options) {
    ...
    dispatchAudioAction(options && options.audioAction ? options.audioAction : 'call', { amount: amount });
  ...
  FXOverlay.bigBet = function (amount, options) {
    ...
    dispatchAudioAction(options && options.audioAction ? options.audioAction : 'raise', { amount: amount });
  ...
  FXOverlay.allIn = function (amount, options) {
    ...
    dispatchAudioAction(options && options.audioAction ? options.audioAction : 'allIn', { amount: amount });
